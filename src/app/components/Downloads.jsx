...
const Downloads = () => {
  return (
    <section id="download" className="section-gap scroll-mt-24 h-[450px] xs:h-[500px] cxs:h-[550px] md:h-[610px] cmd:h-[680px] lg:h-auto">
      <div className="w-full relative h-[330px] xs:h-[350px] cxs:h-[380px] cmd:h-[450px] lg:h-[570px] bg-[#121212] lg:bg-[url('/uploads/last.png.png')]  bg-no-repeat bg-right bg-cover 3xl:bg-contain sm:bg-[length:80%_100%] md:bg-[length:80%_100%] lg:bg-[length:80%_100%] xl:bg-[length:75%_100%] 2xl:bg-[length:78%_100%]">
        ...
        <div className="2xl:container h-full pl-0 lg:pl-10 3xl:pl-0 mx-auto flex flex-col gap-y-10 lg:gap-y-0 justify-start lg:justify-evenly relative sm:z-10">
          <div className="sm:px-0 relative z-30">
            <h2 className="mt-6 lg:mt-10 uppercase font-supera600 sm:font-supera700 text-[22px] sm:text-[30px] cmd:text-[35px] text-center lg:text-left text-[#FFFFFF]">downloads</h2>
          </div>
          <div className="lg:-mt-10 flex flex-row lg:flex-col justify-center lg:justify-start gap-y-[36px] relative z-30">
            <button aria-label="Brochure" className="w-[245px] lg:h-[68px] group lg:hover:bg-[url('/uploads/bgimage.png')]  bg-cover bg-center flex flex-col lg:flex-row justify-evenly items-center gap-y-2 lg:gap-y-0 gap-x-2.5 lg:border-[1px] border-[#FFFFFF] rounded-[13px]">
              ...
              <div className="font-supera500 sm:font-supera600 capitalize text-left text-[14px] xs:text-[18px] sm:text-[20px] md:text-[22px] text-[#FFFFFF] lg:group-hover:text-[#fff] tracking-wide">Brochure</div>
            </button>
            <button aria-label="Site Plan" className="w-[245px] lg:h-[68px] group lg:hover:bg-[url('/uploads/bgimage.png')] bg-cover bg-center flex flex-col lg:flex-row justify-evenly items-center gap-y-2 lg:gap-y-0 gap-x-2.5 lg:border-[1px] border-[#FFFFFF] rounded-[13px]">
              <div className="size-[70px] sm:size-[80px] rounded-full lg:rounded-none lg:size-auto border-[1.08px] border-[#FFFFFF] lg:border-none flex justify-center items-center lg:block">
                <svg width="36" height="36" viewBox="0 0 36 36" className="stroke-[#fff] lg:group-hover:stroke-[#fff] fill-none" xmlns="http://www.w3.org/2000/svg">
                  <path d="M18.1875 11.7057L27.8932 6.85284L18.1875 2V18.1761" className="stroke-[#fff] lg:group-hover:stroke-[#fff]" strokeWidth="3" strokeLinecap="round" strokeLinejoin="round"></path>
