...
export default function BrochureSection() {
  return (
    <section
      ...
      className="w-full h-screen bg-cover bg-top bg-no-repeat relative flex flex-col justify-between"
    >
      ...
      <div className="2xl:container h-full mx-auto flex flex-col sm:flex-row gap-y-[60px] sm:gap-x-[60px] justify-center items-center px-5 xs:px-7 sm:px-10 lg:px-16 cmd:pb-[45px] relative z-30 flex-grow pb-10">
        ...
        <div className="flex flex-col items-start mx-auto w-full sm:w-1/2 lg:w-1/3 sm:items-start lg:items-start sm:ml-[-40px]"> {/* Adjusted to move the content to the left */}
          ...
          <p className="mt-2 font-supera500 text-[15px] bxxs:text-[16px] xs:text-[18px] text-[#fff] capitalize text-left cmd:text-left sm:text-left">
        ...
        <div className="w-full sm:w-1/2 lg:w-1/3 flex flex-col items-start sm:items-center cmd:items-start">
          <div className="flex flex-col sm:flex-row items-center gap-y-4 sm:gap-x-4">
            {/* Spread Info */}
            <div className="flex flex-row sm:flex-col items-center justify-start sm:justify-normal gap-y-0.5 cmd:block h-[95px] xs:h-[78px] cmd:h-[74px] lg:h-[85px] xl:h-[105px] sm:border-r sm:border-[#FFFFFF] sm:pr-[38px] mb-6"> {/* Added bottom margin here */}
            ...
            {/* Handover Date */}
            <div className="flex flex-row sm:flex-col items-center justify-start sm:justify-normal gap-y-0.5 cmd:block h-[95px] xs:h-[78px] cmd:h-[74px] lg:h-[85px] xl:h-[105px] sm:pl-[38px] mb-6"> {/* Added bottom margin here */}
