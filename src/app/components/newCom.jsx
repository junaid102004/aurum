    ...
    <section className="section-gap">
      <div>
        <div className="px-5 sm:px-5 mb-[20px] xl:container mx-auto">
          ...
          <p className="font-supera600 capitalize cmd:mt-1.5 max-w-full tracking-wide sm:tracking-normal text-[13px] cxs:text-sm sm:text-[15px] md:text-[16px] cmd:text-[18px] leading-[14px] xs:leading-[18px] sm:leading-[20px] cmd:leading-[22px] text-center text-[#5A5454]"></p>
        </div>
      </div>
          ...
          <div className="md:mt-16 w-[90%] 2xl:w-[70%] h-full mx-auto pb-8 md:py-0 flex gap-7 md:gap-0 justify-start cxs:justify-around md:justify-between items-start md:items-center flex-wrap md:flex-nowrap">
            ...
            <div className="relative md:w-[200px] cmd:w-[250px] flex flex-row md:flex-col justify-start md:justify-center items-center gap-x-4 md:gap-x-0">
              ...
              <div className="font-supera500 tracking-wide text-[13.5px] xs:text-[18px] cxs:text-[15px] lg:text-[18px] xl:text-[20px] text-[#fff]">
                <button aria-label="info@realtynivesh.com">
                  info@realtynivesh.com
                </button>
              </div>
            </div>
            {/* Address Contact */}
            <div className="relative cxs:md:w-[250px] cmd:w-[340px] flex flex-row md:flex-col justify-start md:justify-center items-center gap-x-4 md:gap-x-0">
              <div className="md:absolute bottom-[125%] lg:bottom-[110%] min-w-[50px] min-h-[50px] sm:size-[61.33px] bg-backgroud-theme-local bg-cover bg-center rounded-full border-[1.5px] border-[#fff] flex justify-center items-center">
                ...
                >
                  <path
                    d="M10.2784 0.137207C7.63045 0.140331 5.09189 1.19359 3.21953 3.06595C1.34717 4.93831 0.293906 7.47688 0.290782 10.1248C0.287611 12.2887 0.994435 14.3938 2.30283 16.1173C2.30283 16.1173 2.57521 16.476 2.6197 16.5277L10.2784 25.5601L17.9407 16.5232C17.9806 16.4751 18.2539 16.1173 18.2539 16.1173L18.2548 16.1146C19.5632 14.3918 20.2701 12.2867 20.2668 10.1248C20.2638 7.47688 19.2106 4.93831 17.3382 3.06595C15.4659 1.19359 13.0273 0.140331 10.2784 0.137207ZM10.2784 14.1248C8.56383 14.1248 7.03439 12.5943 7.03439 10.8748C7.03439 9.15536 8.56383 7.62482 10.2784 7.62482C12.0183 7.62482 13.5486 9.15536 13.5486 10.8748C13.5486 12.5943 12.0183 14.1248 10.2784 14.1248Z"
                    fill="white"
                  ></path>
                </svg>
              </div>
              <div className="font-supera500 tracking-wide text-[13.5px] xs:text-[18px] cxs:text-[15px] lg:text-[18px] xl:text-[20px] text-[#fff]">
                <button aria-label="Location address">
                  VASANT VIHAR 2, BIKANER, RAJASTHAN
                </button>
              </div>
            </div>
          </div>
