  ...
  return (
    <section id="about-us" className="section-gap scroll-mt-24">
      <div className="bg-[#0b0b0b]">
        <div className="md:bg-aboutus-bgSectionImg-local bg-cover bg-left bg-no-repeat w-full h-full">
          <div className="bg-aboutus-bgContainer-local bg-cover bg-no-repeat w-full max-w-[100%] sm:max-w-[95%] lg:max-w-[90%] 3xl:max-w-[1400px] mx-auto pt-[40px] md:pt-[30px] md:py-[60px] pb-[35px] flex flex-col md:flex-row gap-4 cmd:gap-5 xl:gap-8 3xl:gap-4 xl:justify-center items-center">
            ...
            <div className="w-full md:w-[60%] mt-1.5 cxs:mt-0 md:mt-0 flex flex-col gap-5 px-5 md:px-0 lg:pl-0 2xl:pl-8 md:pr-8 2xl:pr-0">
              ...
              <button
                ...
                className="md:w-[167px] md:h-[38px] md:flex justify-center items-center font-supera600 capitalize md:uppercase text-[16px] sm:text-[20px] md:text-[24px] text-[#F9A221] md:text-[#000] rounded-md bg-right md:bg-backgroud-theme-local cursor-pointer text-justify tracking-wide"
              >
                Read more
              </button>
            </div>
