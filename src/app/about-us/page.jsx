    ...
    <section id="about-us" className="section-gap scroll-mt-24">
      <div className="bg-[#0b0b0b]">
        <div className="mt-10 md:bg-[url('/uploads/group1.png')]  bg-cover bg-left bg-no-repeat w-full h-full">
          <div className="bg-black  bg-cover bg-no-repeat w-full max-w-[100%] sm:max-w-[95%] lg:max-w-[90%] 3xl:max-w-[1400px] mx-auto pt-[40px] md:pt-[30px] md:py-[60px] pb-[35px] flex flex-col md:flex-row gap-4 cmd:gap-5 xl:gap-8 3xl:gap-4 xl:justify-center items-center">
